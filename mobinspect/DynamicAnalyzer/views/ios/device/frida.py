...
from mobinspect.DynamicAnalyzer.views.ios.frida_core import Frida
...
class FridaIOSDevice(Frida):
    ...
    def __init__(
        ...
        #   MobInspect starts this automatically via _setup_usb_port_forward().
        ...
        #   created by MobInspect. When running in Docker/Colima, run iproxy
        #   on the macOS host before starting MobInspect:
        #     iproxy -s 0.0.0.0 2222:22 27042:27042 -u <udid>
        #   Then set MOBINSPECT_IOS_ANALYZER_IDENTIFIERS=host.lima.internal:2222
