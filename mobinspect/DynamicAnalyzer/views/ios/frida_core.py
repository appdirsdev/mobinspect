...
from mobinspect.DynamicAnalyzer.views.ios.corellium_ssh import (
    ssh_jumphost_port_forward,
)
from mobinspect.DynamicAnalyzer.views.ios.frida_auxiliary_scripts import (
    class_pattern,
    class_trace,
    classes_with_method,
    get_loaded_classes,
...
class Frida:
    ...
    def __init__(
        ...
        self.frida_log = self.ipa_dir / 'mobinspect_frida_out.txt'
        self.dump_file = self.ipa_dir / 'mobinspect_dump_file.txt'
        self.container_file = self.ipa_dir / 'mobinspect_app_container_path.txt'
