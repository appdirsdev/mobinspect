...
Wraps ``mobinspect.MobInspect.init.bootstrap_admin`` so deploy scripts (entrypoint,
...
``mobinspect/mobinspect`` superuser.
...
to ``<MOBINSPECT_HOME>/initial-admin-password.txt`` (mode 0600).
"""
from django.core.management.base import BaseCommand

from mobinspect.MobInspect.init import bootstrap_admin
