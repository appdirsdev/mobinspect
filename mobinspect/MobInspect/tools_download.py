...
from mobinspect.MobInspect.exceptions import PathTraversalError
...
def standalone_upstream_proxy():
    ...
    # Deferred import: mobinspect.MobInspect.init imports this module (for
    ...
    if upstream_proxy_enabled:
        upstream_proxy_username = env(
            'MOBINSPECT_UPSTREAM_PROXY_USERNAME', '')
        upstream_proxy_password = env(
            'MOBINSPECT_UPSTREAM_PROXY_PASSWORD', '')
