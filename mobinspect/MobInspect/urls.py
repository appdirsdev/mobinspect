...
from mobinspect.DynamicAnalyzer.views.android import dynamic_analyzer as dz
...
from mobinspect.DynamicAnalyzer.views.ios import dynamic_analyzer as idz
from mobinspect.DynamicAnalyzer.views.ios import (
    corellium_instance as instance,
    report as ios_view_report,
    tests_frida as ios_tests_frida,
)
from mobinspect.DynamicAnalyzer.views.ios.device import (
...
from mobinspect.MobInspect.security import (
    init_exec_hooks,
    store_exec_hashes_at_first_run,
)
from mobinspect.MobInspect.views import (
    authentication,
    authorization,
    healthz,
    home,
...
from mobinspect.MobInspect.views.api import api_static_analysis as api_sz
from mobinspect.MobInspect.views.api import api_android_dynamic_analysis as api_dz
from mobinspect.MobInspect.views.api import api_ios_dynamic_analysis as api_idz
from mobinspect.MobInspect.views.api import api_ios_device_analysis as api_iddz
from mobinspect.StaticAnalyzer import tests
from mobinspect.StaticAnalyzer.views.common import (
    appsec,
    async_task,
    pdf,
    shared_func,
...
from mobinspect.StaticAnalyzer.views.android.views import (
    find,
    manifest_view,
    source_tree,
    view_source,
...
from mobinspect.StaticAnalyzer.views.android import static_analyzer as android_sa
from mobinspect.StaticAnalyzer.views.ios import static_analyzer as ios_sa
from mobinspect.StaticAnalyzer.views.ios.views import view_source as io_view_source
...
urlpatterns = [
    # MobInspect — unauthenticated health probes for monitors. Listed first
    # so they short-circuit before any auth/rate-limit decorators on later
    # routes can interfere.
    re_path(r'^healthz/?$',
            healthz.healthz,
            name='healthz'),
    re_path(r'^readyz/?$',
            healthz.readyz,
            name='readyz'),
    # MobInspect — design system playground (DEBUG-only)
    re_path(r'^_playground/$',
            playground.playground,
            name='playground'),
    # MobInspect — RBAC admin UI
    re_path(r'^rbac/', include('mobinspect.RBAC.urls')),
    # MobInspect — Analytics dashboard
    re_path(r'^analytics/', include('mobinspect.Analytics.urls')),
    re_path(r'^login/$',
...
if settings.API_ONLY == '0':
    urlpatterns.extend([
        ...
        re_path(r'^mobinspect_ca/$', operations.mobinspect_ca),
...
if settings.API_ONLY == '0':
    try:
        from mobinspect.StaticAnalyzer.views.common.llm import views as _ai_views
        urlpatterns.append(
