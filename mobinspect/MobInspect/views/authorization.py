...
from mobinspect.MobInspect.forms import RegisterForm
...
def _mirror_rbac_role_groups():
    ...
    try:
        ...
        from mobinspect.RBAC.signals import LEGACY_PERMISSION_MAP
    except Exception:
...
def delete_user(request):
    ...
    try:
        ...
        from mobinspect.RBAC.models import AuditEvent, RoleAssignment
        u.groups.clear()
