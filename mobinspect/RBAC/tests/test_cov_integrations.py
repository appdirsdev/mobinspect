"""
Coverage tests for the NEW integration views in mobinspect/RBAC/views.py:
...
Fixture / auth style mirrors mobinspect/RBAC/test_cov_views.py: a locally-defined
...
from mobinspect.RBAC.models import AdbConnection, AuditEvent, ModelIntegration
