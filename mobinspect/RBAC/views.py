...
URLs (registered under /rbac/ in mobinspect.RBAC.urls):
  /rbac/roles/                       list
...
from mobinspect.RBAC.forms import (
    ApiKeyForm,
    RoleAssignmentForm,
    RoleForm,
...
def role_assign(request, role_id):
    ...
    from mobinspect.RBAC.permissions import effective_user, get_user_permissions
...
def _validate_host_port(raw):
    ...
    """
    from mobinspect.MobInspect.utils import SSH_DEVICE_ID_REGEX
    value = (raw or '').strip()
