...
from mobinspect.StaticAnalyzer.tools.androguard4.apk import (
    APK,
    BrokenAPKError,
    FileNotPresent,
    ensure_final_value,
...
# .../mobinspect/StaticAnalyzer/tools/androguard4/ -> repo root is 4 dirs up
...
def test_manifest_axml_and_xml(apk):
    from mobinspect.StaticAnalyzer.tools.androguard4.axml import AXMLPrinter
...
def test_android_resources(apk):
    from mobinspect.StaticAnalyzer.tools.androguard4.axml import ARSCParser
