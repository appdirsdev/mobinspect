# -*- coding: utf_8 -*-
"""Coverage tests for mobinspect/StaticAnalyzer/views/common/llm/client.py.
...
Style follows ``mobinspect/StaticAnalyzer/views/common/llm/test_cov_signals.py``
(same directory) and ``mobinspect/RBAC/tests/test_permissions.py`` /
...
from mobinspect.RBAC.models import ModelIntegration
from mobinspect.StaticAnalyzer.views.common.llm import client as client_mod
from mobinspect.StaticAnalyzer.views.common.llm.client import (
    GraniteClient,
    _host_is_enclave,
    parse_ai_endpoint,
)
...
def test_generate_failure_log_never_contains_prompt_or_system_body(
    ...
    the ``mobinspect.StaticAnalyzer`` logger tree, so records never reach
