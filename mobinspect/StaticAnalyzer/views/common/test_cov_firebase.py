...
functions in ``mobinspect.StaticAnalyzer.views.common.firebase`` with real
...
def test_firebase_db_check_with_firebase_url():
    ...
    code_an_dic = {'urls_list': [
        'https://example.com/x',
        'https://mobinspect-nope-xyz.firebaseio.com',
        'https://mobinspect-nope-xyz.firebaseio.com',  # dup -> deduped by set
    ]}
    findings = firebase_db_check(CHECKSUM, code_an_dic)
...
def test_firebase_analysis_combines_findings():
    ...
    code_an_dic = {
        'urls_list': ['https://mobinspect-nope-xyz.firebaseio.com'],
        'firebase_creds': {
            'google_api_key': 'AIzaFakeInvalidKey',
            'google_app_id': '1:1234567890:android:abcdef',
        },
