...
from mobinspect.StaticAnalyzer.views.ios.appstore import app_search
...
from mobinspect.StaticAnalyzer.views.ios.code_analysis import ios_source_analysis
...
from mobinspect.StaticAnalyzer.views.ios.strings import (
...
from mobinspect.MalwareAnalyzer.views.MalwareDomainCheck import (
    MalwareDomainCheck,
)
...
def ipa_analysis_task(checksum, app_dic, rescan, queue=False):
    ...
    try:
        ...
        if not extract_and_check_ipa(checksum, app_dic):
            msg = ('IPA is malformed! MobInspect cannot find Payload directory')
