# -*- coding: utf_8 -*-
"""Real-execution unit tests for mobinspect.StaticAnalyzer.views.windows.windows.
...
from mobinspect.MobInspect.views.scanning import (
    add_to_recent_scan,
...
from mobinspect.StaticAnalyzer.views.windows.windows import (
    _parse_xml,
    get_short_desc,
    parse_binskim,
    parse_binskim_old,
