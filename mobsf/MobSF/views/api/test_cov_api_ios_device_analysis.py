...
from mobsf.MobSF.views.api import api_ios_device_analysis as mod
...
def test_dynamic_analysis_entrypoint_ok(rf, superuser):
    ...
    prev = os.environ.get('MOBSF_PLATFORM')
    ...
    try:
        ...
        if prev is None:
            ...
            os.environ['MOBSF_PLATFORM'] = prev
...
def test_api_monitor_with_real_dump_file_returns_200(rf, tmp_path):
    ...
    dump = app_dir / 'mobsf_dump_file.txt'
    dump.write_text(
