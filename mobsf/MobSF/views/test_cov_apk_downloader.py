...
``mobsf.MobSF.views.apk_downloader`` with REAL sample files from the
...
from mobsf.MobSF.views import apk_downloader as ad
from mobsf.StaticAnalyzer.models import RecentScansDB


# settings.BASE_DIR points at the inner ``mobsf`` package dir; the sample
