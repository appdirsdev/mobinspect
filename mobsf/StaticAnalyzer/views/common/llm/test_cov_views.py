...
mobsf/StaticAnalyzer/views/common/llm/views.py (AI Security Analysis).

Follows the fixture/setup conventions of mobsf/RBAC/test_cov_views.py and
mobsf/RBAC/tests/test_permissions.py: users/roles are built directly against
